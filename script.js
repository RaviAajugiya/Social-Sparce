...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        $(window).scrollTop() >= 250 ? $(".main-header").addClass("fixed-header") : $(".main-header").removeClass("fixed-header")
    }),
    $(document).ready(function () {
        ...
        return e.defaults = {
            ...
            e.prototype.start = function (e) {
                ...
                n.on("resize", t.proxy(this.sizeOverlay, this)),
                    ...
                    this.sizeOverlay(),
                    this.album = [];
                var s, a = 0, r = e.attr("data-lightbox");
                if (r) {
            ...
            e.prototype.changeImage = function (e) {
                ...
                n.onload = function () {
                    ...
                    o.attr("src", i.album[e].link),
                        ...
                        o.width(n.width),
                        o.height(n.height),
                        i.options.fitImagesInViewport && (c = t(window).width(),
                            d = t(window).height(),
                            h = c - i.containerLeftPadding - i.containerRightPadding - 20,
                            l = d - i.containerTopPadding - i.containerBottomPadding - 120,
                            i.options.maxWidth && i.options.maxWidth < h && (h = i.options.maxWidth),
                            i.options.maxHeight && i.options.maxHeight < h && (l = i.options.maxHeight),
                            (n.width > h || n.height > l) && (n.width / h > n.height / l ? (r = h,
                                a = parseInt(n.height / (n.width / r), 10),
                                o.width(r),
                                o.height(a)) : (a = l,
                                    r = parseInt(n.width / (n.height / a), 10),
                                    o.width(r),
                                    o.height(a)))),
            ...
            e.prototype.sizeContainer = function (t, e) {
                function i() {
                    o.$lightbox.find(".lb-dataContainer").width(a),
                        o.$lightbox.find(".lb-prevLink").height(r),
                        o.$lightbox.find(".lb-nextLink").height(r),
                        o.showImage()
                }
                var o = this
